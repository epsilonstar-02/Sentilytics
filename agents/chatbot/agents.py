...
# This agent answers questions about video metadata (views, likes, titles, etc.)
yt_metadata_agent = LlmAgent(
    ...
    - "iPhone 17 Pro" (for iPhone 17 Pro)
    - "MacBook Pro 14-inch M5" (for MacBook Pro M5)
    - "ChatGPT GPT-5" (for ChatGPT/GPT-5)
    
    Note: The system will automatically normalize various user inputs to these exact names.
...
# This agent searches transcripts for specific content.
...
# This agent fetches live channel info.
...
# This agent analyzes sentiment of videos and products.
sentiment_agent = LlmAgent(
    ...
    IMPORTANT - Use these EXACT product names when calling tools:
    - "iPhone 17 Pro" (for iPhone 17 Pro) - HAS SENTIMENT DATA
    - "MacBook Pro 14-inch M5" (for MacBook Pro M5) - HAS SENTIMENT DATA
    - "ChatGPT GPT-5" (for ChatGPT/GPT-5) - HAS SENTIMENT DATA
...
# NEW: This agent performs cross-product comparative analysis
...
# NEW: This agent analyzes trends over time
...
# Coordinator Agent
# This agent routes the user's request to the appropriate specialist.
